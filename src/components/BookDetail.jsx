...
export default function BookDetail() {
  ...
  return (
    <section
      id="book"
      className="py-24 bg-gradient-to-b from-[#E8F5E9] to-white relative overflow-hidden"
    >
      {/* Floating leaves */}
      <div className="absolute top-10 left-10 text-5xl opacity-20 animate-leaf">
        🌿
      </div>
      <div className="absolute top-40 right-10 text-4xl opacity-15 animate-leaf-delayed">
        🍃
      </div>
      <div className="absolute bottom-20 left-1/4 text-6xl opacity-10 animate-leaf">
        🌱
      </div>
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        <div className="text-center mb-16">
          ...
          <p className="text-xl font-bubblegum text-[#FF8F3D]">
            {book.tagline}
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center max-w-5xl mx-auto">
          ...
          <div className="relative mx-auto max-w-sm">
            ...
            >
              <div
                className={`relative transition-all duration-700 ${showBack ? "scale-105" : ""}`}
              >
              ...
              {/* Flip instruction */}
              <div className="absolute -bottom-7 left-1/2 -translate-x-1/2 bg-white rounded-full px-2 py-2 shadow-lg border-2 border-[#FF8F3D]">
                <span className="text-sm font-nunito font-bold text-[#FF8F3D] flex items-center gap-0.1">
          ...
          <div className="space-y-6">
            ...
            {book.status && (
              <div className="inline-flex items-center gap-2 bg-[#4CAF50]/10 border border-[#4CAF50]/30 rounded-full px-4 py-2">
                ...
                <span className="text-sm font-nunito font-bold text-[#2E7D32]">
                  {book.statusText}
                </span>
              </div>
            )}
            ...
            {/* Dedication */}
            {book.dedication && (
              <div className="bg-[#FFF3E0] rounded-2xl p-5 border-2 border-[#FF8F3D]/20 text-center">
                <span className="text-2xl block mb-2">💝</span>
                <p className="text-[#5D4037] font-nunito font-bold italic">
                  {book.dedication}
                </p>
              </div>
            )}
            ...
            {/* Artist Credit */}
            {book.description2 && (
              <div className="bg-[#E8F5E9] rounded-2xl p-5 border-2 border-[#4CAF50]/20">
                <div className="flex items-center gap-2 mb-2">
                  <span className="text-xl">🎨</span>
                  <span className="text-xs font-nunito font-bold text-[#4CAF50] tracking-wider uppercase">
                    Illustrated by Adrian, Age 6
                  </span>
                </div>
                <p className="text-[#5D4037]/60 leading-relaxed font-nunito text-sm">
                  {book.description2}
                </p>
              </div>
            )}
